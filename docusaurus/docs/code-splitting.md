...
If you are using React Router check out [this tutorial](https://serverless-stack.com/chapters/code-splitting-in-create-brahmos-app.html) on how to use code splitting with it. You can find the companion GitHub repository [here](https://github.com/AnomalyInnovations/serverless-stack-demo-client/tree/code-splitting-in-create-brahmos-app).
