...
following in their [`src/index.js`](https://github.com/facebook/create-brahmos-app/blob/master/packages/brahmos-scripts/template/src/index.js) file:
...
However, they [can make debugging deployments more challenging](https://github.com/facebook/create-brahmos-app/issues/2398) so, starting with Create React App 2, service workers are opt-in.
...
1. After the initial caching is done, the [service worker lifecycle](https://developers.google.com/web/fundamentals/primers/service-workers/lifecycle)
   ...
   [race conditions with lazy-loaded content](https://github.com/facebook/create-brahmos-app/issues/3613#issuecomment-353467430),
...
1. Users aren't always familiar with offline-first web apps. It can be useful to
   ...
   starting point, you can make use of the logic included in [`src/serviceWorker.js`](https://github.com/facebook/create-brahmos-app/blob/master/packages/brahmos-scripts/template/src/serviceWorker.js), which
...
1. If you _need_ to test your offline-first service worker locally, build
   ...
   build directory. After running the build script, `create-brahmos-app` will give
...
[`public/manifest.json`](https://github.com/facebook/create-brahmos-app/blob/master/packages/brahmos-scripts/template/public/manifest.json), that you can customize with
details specific to your web application.

When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in [`manifest.json`](https://github.com/facebook/create-brahmos-app/blob/master/packages/brahmos-scripts/template/public/manifest.json) determines what
