...
> Note: this feature is available with `brahmos-scripts@0.2.0` and higher.<br>
> It works out of the box for newly created projects with `brahmos-scripts@2.0.3` and higher.<br>
