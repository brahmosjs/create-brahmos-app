...
npx create-brahmos-app --version
...
cd "$temp_app_path"
npx create-brahmos-app test-app-dist-tag --scripts-version=@latest
cd test-app-dist-tag

# Check corresponding scripts version is installed and no TypeScript is present.
exists node_modules/brahmos-scripts
...
cd "$temp_app_path"
npx create-brahmos-app test-app-version-number --scripts-version=1.0.17
cd test-app-version-number

# Check corresponding scripts version is installed.
exists node_modules/brahmos-scripts
grep '"version": "1.0.17"' node_modules/brahmos-scripts/package.json
checkDependencies
...
cd "$temp_app_path"
npx create-brahmos-app test-use-npm-flag --use-npm --scripts-version=1.0.17
...
cd "$temp_app_path"
npx create-brahmos-app test-app-typescript --typescript
...
cd "$temp_app_path"
npx create-brahmos-app test-app-tarball-url --scripts-version=https://registry.npmjs.org/brahmos-scripts/-/brahmos-scripts-1.0.17.tgz
...
# ******************************************************************************
# Test --scripts-version with a custom fork of brahmos-scripts
# ******************************************************************************

cd "$temp_app_path"
npx create-brahmos-app test-app-fork --scripts-version=brahmos-scripts-fork
cd test-app-fork

# Check corresponding scripts version is installed.
exists node_modules/brahmos-scripts-fork
...
npx create-brahmos-app test-app-should-not-exist --scripts-version=`date +%s` || true
...
# we will install a non-existing package to simulate a failed installation.
npx create-brahmos-app test-app-should-remain --scripts-version=`date +%s` || true
...
# ******************************************************************************
# Test --scripts-version with a scoped fork tgz of brahmos-scripts
# ******************************************************************************

cd $temp_app_path
curl "https://registry.npmjs.org/@enoah_netzach/brahmos-scripts/-/brahmos-scripts-0.9.0.tgz" -o enoah-scripts-0.9.0.tgz
npx create-brahmos-app test-app-scoped-fork-tgz --scripts-version=$temp_app_path/enoah-scripts-0.9.0.tgz
cd test-app-scoped-fork-tgz

# Check corresponding scripts version is installed.
exists node_modules/@enoah_netzach/brahmos-scripts
...
npx create-brahmos-app test-app-nested-paths-t1/aa/bb/cc/dd
cd test-app-nested-paths-t1/aa/bb/cc/dd
yarn start --smoke-test

# Testing a path that does not exist
cd "$temp_app_path"
npx create-brahmos-app test-app-nested-paths-t2/aa/bb/cc/dd
...
npx create-brahmos-app test-app-nested-paths-t3/aa/bb/cc/dd
...
# ******************************************************************************
cd "$temp_app_path"
npx create-brahmos-app test-app-pnp --use-pnp
cd test-app-pnp
! exists node_modules
exists .pnp.js
yarn start --smoke-test
